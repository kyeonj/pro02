	...
	<div class="row" id="content_row">
		...
		<% } %>
			...
			<div class="btn-group">
				...
				<% if(vo.getParselState()==0) { %>
				<a href="<%=request.getContextPath() %>/DeleteSalesCtrl?saleNo=<%=vo.getSaleNo() %>" class="btn btn-outline-info">직권 결제 취소</a>&nbsp;&nbsp;
				<% } %>
				<a href="<%=request.getContextPath() %>/UpdateParselCtrl?parselNo=<%=vo.getParselNo() %>" class="btn btn-outline-info">배송 정보 등록 및 수정</a>
			</div>
		</main>
	</main>		
</div>
