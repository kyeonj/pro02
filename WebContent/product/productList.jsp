...
<div class="container-fluid" id="content">
	<div class="row" id="content_row">
		...
		<% } %>
				...
				<li class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
					<div class="card" style="width: 18rem;">
					  ...
					  <div class="card-body">
					    ...
					    <p class="card-text"><strong style="color:green;"><%=pro.getProPrice() %>원</strong> (<del><%=pro.getOriPrice() %>)</del></p>
					    <a href="<%=request.getContextPath() %>/GetProductDetailCtrl?proNo=<%=pro.getProNo() %>" class="btn btn-outline-info">제품 상세보기</a>
					  </div>
					</div>
				</li>
			<% } %>
			...
			<% if(sid.equals("admin")) { %>
			<div class="btn-group">
				<a href="<%=request.getContextPath() %>/InsertProductCategoryCtrl" class="btn btn-outline-info">상품 등록</a>
			</div>
			<% } %>
		</main>
	</div>
