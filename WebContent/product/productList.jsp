...
<div class="content container" id="content">
		...
		<li class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
			<div class="card" style="width: 18rem;">
			  ...
			  <div class="card-body">
			    ...
			    <a href="<%=request.getContextPath() %>/GetProductDetailCtrl?proNo=<%=pro.getProNo() %>" class="btn btn-secondary">제품 상세보기</a>
			  </div>
			</div>
		</li>
	<% } %>
	...
	<% if(sid.equals("admin")) { %>
	<div class="btn-group">
		<a href="<%=request.getContextPath() %>/InsertProductCategoryCtrl" class="btn btn-secondary">상품 등록</a>
	</div>
	<% } %>
	<%} %>
</div>
