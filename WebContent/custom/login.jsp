...
<div class="content container" id="content">
	...
	<form name="frm1" id="frm1" action="<%=request.getContextPath() %>/CustomLoginCtrl" method="post">
		...
		<div class="btn-group">
			<input type="submit" name="submit-btn" class="btn btn-outline-info" value="로그인">&nbsp;&nbsp;
			<input type="reset" name="reset-btn" class="btn btn-outline-info" value="취소">&nbsp;&nbsp;
			<a href="<%=request.getContextPath() %>/custom/membership.jsp" class="btn btn-outline-info">회원가입</a>
		</div>
	</form>	
</div>
